...
# 6. Full parallel audit (245 audit-visible lenses)
...
> [!NOTE]
> RepoLens generates a lot of automated traffic. A default 245-lens audit run can create dozens to hundreds of remote issues, plus repo reads via `gh`, `tea`, or `fj`, plus parallel AI provider calls.
...
| ------------ | ----------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| `audit`      | 3×          | 27 code/toolgate/logs domains (245 lenses) | **Default.** Standard code audit — finds issues in existing code              |
| `feature`    | 3×          | 27 code/toolgate/logs domains (245 lenses) | Feature gap discovery — identifies missing capabilities                       |
| `bugfix`     | 3×          | 27 code/toolgate/logs domains (245 lenses) | Bug hunting — finds real bugs and defects                                     |
...
| `custom`     | 1×          | 27 code/toolgate/logs domains (245 lenses) | Change impact analysis — identifies what needs adapting after a change        |
...
## Domains & Lenses (332 total across 32 domains)
