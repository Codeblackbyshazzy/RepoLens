...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (8 lenses) | Server or Android APK audit — inspects a live server or APK target          |
...
## Domains & Lenses (305 total across 31 domains)
