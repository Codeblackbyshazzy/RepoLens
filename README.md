...
# 6. Full parallel audit (223 audit-visible lenses)
...
> [!NOTE]
> RepoLens generates a lot of automated traffic. A default 223-lens audit run can create dozens to hundreds of remote issues, plus repo reads via `gh`, `tea`, or `fj`, plus parallel AI provider calls.
...
|------|-------------|---------|-------------|
| `audit` | 3× | 26 code/toolgate domains (223 lenses) | **Default.** Standard code audit — finds issues in existing code |
| `feature` | 3× | 26 code/toolgate domains (223 lenses) | Feature gap discovery — identifies missing capabilities |
| `bugfix` | 3× | 26 code/toolgate domains (223 lenses) | Bug hunting — finds real bugs and defects |
...
| `custom` | 1× | 26 code/toolgate domains (223 lenses) | Change impact analysis — identifies what needs adapting after a change |
...
## Domains & Lenses (293 total across 30 domains)
...
| **Infrastructure as Code** | 1 | Terraform completeness, placeholder stubs, empty resource blocks, dead modules, missing outputs, broken references, provider/backend hygiene, disabled resources, zero-resource plans, README-vs-code infrastructure promises |
