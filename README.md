...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (3 lenses) | Server or Android APK audit — inspects a live server or APK target          |
...
## Domains & Lenses (300 total across 31 domains)
...
| **Android**               | `deploy`     | 3 lenses  | APK overview, package metadata, APK secrets, credentials, internal URLs, WebView security settings, JavaScript bridges, and device-aware Android audit context                                                                                    |
