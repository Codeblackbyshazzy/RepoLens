...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (16 lenses) | Server or Android APK audit — inspects a live server or APK target         |
...
## Domains & Lenses (313 total across 31 domains)
