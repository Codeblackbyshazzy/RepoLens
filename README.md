...
# 6. Full parallel audit (233 audit-visible lenses)
...
> [!NOTE]
> RepoLens generates a lot of automated traffic. A default 233-lens audit run can create dozens to hundreds of remote issues, plus repo reads via `gh`, `tea`, or `fj`, plus parallel AI provider calls.
...
| ------------ | ----------- | ------------------------------------------ | ----------------------------------------------------------------------------- |
| `audit`      | 3×          | 27 code/toolgate/logs domains (233 lenses) | **Default.** Standard code audit — finds issues in existing code              |
| `feature`    | 3×          | 27 code/toolgate/logs domains (233 lenses) | Feature gap discovery — identifies missing capabilities                       |
| `bugfix`     | 3×          | 27 code/toolgate/logs domains (233 lenses) | Bug hunting — finds real bugs and defects                                     |
...
| `custom`     | 1×          | 27 code/toolgate/logs domains (233 lenses) | Change impact analysis — identifies what needs adapting after a change        |
...
## Domains & Lenses (320 total across 32 domains)
