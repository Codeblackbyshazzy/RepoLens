...
assert_eq "logs domain registers logs lenses" "error-storms,error-cascades,retry-loops,recursive-growth,resource-leaks,log-gaps,missing-heartbeats,silent-failures,state-machine-violations,lifecycle-violations,process-orphans" "$logs_lenses"
