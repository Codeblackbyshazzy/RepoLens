...
The current lens inventory spans 28 domains with 284 total lenses, broken down as: 196 code analysis + 18 tool gate + 14 product discovery + 26 deployment/server audit + 13 open-source readiness + 17 content quality.
...
LBA takes the opposite approach. By assigning one prompt per concern (284 total), each lens can devote its full context window and specialization depth to a single domain. The advantages of this decomposition include:
...
|------|---------|---------------|
| **audit** | Find real issues in existing code | 214 (code + toolgate domains) |
| **feature** | Identify missing capabilities | 214 |
| **bugfix** | Find bugs backed by evidence | 214 |
| **custom** | Change impact analysis | 214 |
